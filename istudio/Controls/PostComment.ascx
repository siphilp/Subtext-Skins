<%@ Control Language="C#" EnableTheming="false"  AutoEventWireup="false" Inherits="Subtext.Web.UI.Controls.PostComment" %>
    ...
    <p class="comment-form-author"><asp:Label AssociatedControlID="tbName" runat="server" Text="Name" /> 
    ...
    <p class="comment-form-email"><asp:Label ID="Label1" AssociatedControlID="tbTitle" runat="server" Text="Title" /> <asp:RequiredFieldValidator id="vldTitleRequired" runat="server" ErrorMessage="Please enter a title" ControlToValidate="tbTitle" Display="Dynamic" EnableClientScript="true"  CssClass="requiredd" />
  ...
  <div style="clear:both;"></div>
    ...
    <p style="margin-top:30px" class="comment-form-comment"><asp:Label ID="Label4" AssociatedControlID="tbComment" runat="server" CssClass="textarea " Text="Your Comment" />    
    ...
    <p class=""><asp:button id="btnSubmit" cssclass="form-submit" runat="server" /></p>
</div> 
