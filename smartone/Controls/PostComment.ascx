<%@ Control Language="C#" EnableTheming="false"  AutoEventWireup="false" Inherits="Subtext.Web.UI.Controls.PostComment" %>
  ...
  <br /> <asp:Label AssociatedControlID="chkRemember"  runat="server" Text="Remember Me?"><asp:checkbox id="chkRemember" runat="server" TextAlign="Right" checked="True" /></asp:Label>
  ...
  <div class="respond-right">
	...
	<asp:textbox id="tbComment" runat="server" textmode="MultiLine" cols="95%" rows="10" tabindex="5" style="float:left;width:95%;" /></p><br />
