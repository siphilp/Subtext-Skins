<%@ Control Language="C#" EnableTheming="false"  AutoEventWireup="false" Inherits="Subtext.Web.UI.Controls.PreviousNext" %>
    ...
    <div id="nav-below">
    <div class="nav-previous"><span class="meta-nav">←</span> <asp:HyperLink id="PrevLink" runat="server" ToolTip="previous post" Format="{0}" rel="prev" />  </div>
		<div class="nav-next"><asp:HyperLink id="NextLink" runat="server" ToolTip="next post" Format="{0}" rel="next" /> <span class="meta-nav">→</span></div>
