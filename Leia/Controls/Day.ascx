...
<%@ Import Namespace = "Subtext.Framework" %>
	<div class="day">
		<div class="date">
			<asp:hyperlink runat="server" visible="false" title="Day Archive" borderwidth="0" id="ImageLink" ><asp:literal id = "DateTitle" runat = "server" /></asp:hyperlink>
		</div>
	...
	<asp:Repeater runat="Server" Runat="server" ID="DayList" OnItemCreated="PostCreated">
		<ItemTemplate>
			<div class="post">
				...
				<h3><asp:literal id = "PostDesc" runat = "server" /></h3>
				<div class="body">
