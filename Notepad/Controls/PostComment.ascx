<%@ Control Language="C#" EnableTheming="false"  AutoEventWireup="false" Inherits="Subtext.Web.UI.Controls.PostComment" %>
  ...
  <br /> <asp:checkbox id="chkRemember" runat="server" TextAlign="Right" checked="True" /><asp:Label ID="Label5" AssociatedControlID="chkRemember"  runat="server" Text="Remember Me?"></asp:Label>
 
  </div>    

  <div class="respond-right">
    <p><asp:Label ID="Label4" AssociatedControlID="tbComment" runat="server" Text="Comment" style="display:none;" />
