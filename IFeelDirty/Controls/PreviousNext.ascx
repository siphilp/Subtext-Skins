<%@ Control Language="C#" EnableTheming="false"  AutoEventWireup="false" Inherits="Subtext.Web.UI.Controls.PreviousNext" %>
    ...
    <div class="alignleft">«  <asp:HyperLink id="PrevLink" runat="server" ToolTip="previous post" Format="{0}" rel="prev" />  </div>
		<div class="alignright"><asp:HyperLink id="NextLink" runat="server" ToolTip="next post" Format="{0}" rel="next" />  »</div>
